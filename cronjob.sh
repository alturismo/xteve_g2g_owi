...
use_guide2goclean="no"			# yes checks xml's and will cleanup "old" images, only useful use_guide2gocache=yes ...
use_zap="no"				# xml grabber for zap2it
use_owi2plex="yes"			# xml grabber for enigma based STB's
use_xTeveAPI="yes"			# yes enables API update calls after each xml update, may disable xteve's update schedule in webui
use_xTeveRP="no"			# will be dropped
